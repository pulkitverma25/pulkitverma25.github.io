...
<div class="card mt-3 p-3">
    <h3 class="card-title" style="color:#b71c1c;">Flowchart</h3>
    <div class="card-text font-weight-light list-group list-group-flush">
        <img img style="height:auto;width:100%;" src="/assets/img/projects/smart_analyzer/analyzer_flow.png" alt="Flowchart" class="center">
        <p>
